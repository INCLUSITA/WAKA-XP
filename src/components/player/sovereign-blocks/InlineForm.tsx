            ...
            {field.type === "select" && field.options ? (
              <div className="relative">
                <select
                  ...
                  className="w-full h-8 px-2.5 pr-7 text-[12px] text-[hsl(220,15%,15%)] border border-[hsl(220,15%,88%)] rounded-lg bg-white appearance-none focus:ring-1 focus:ring-[hsl(160,60%,40%)]/30 focus:outline-none"
                >
              ...
              <input
                ...
                value={values[field.id] || ""}
                onChange={(e) => handleChange(field.id, e.target.value)}
                className="w-full h-8 px-2.5 text-[12px] text-[hsl(220,15%,15%)] border border-[hsl(220,15%,88%)] rounded-lg bg-white focus:ring-1 focus:ring-[hsl(160,60%,40%)]/30 focus:outline-none transition-shadow"
              />
            )}
          </div>
        ))}
