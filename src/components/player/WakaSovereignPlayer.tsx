...
import { Send, Mic, MicOff, ChevronRight, CheckCheck, ChevronDown, ChevronUp, Zap, Wifi, WifiOff, Camera, X, Image as ImageIcon, MapPin, Paperclip, Phone, User } from "lucide-react";
