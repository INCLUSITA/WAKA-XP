...
export const BLOCK_TYPE_CONFIGS: Record<StructuralBlockType, BlockTypeConfig> = {
  ...
  wait_response: {
    ...
    category: "conversation",
    defaultProperties: { timeout: "5m", resultName: "", hint: "", validationType: "any" },
    propertyFields: [
      { key: "resultName", label: "Save response as", type: "text", placeholder: "@result.response", required: true },
      ...
      { key: "hint", label: "Input hint", type: "text", placeholder: "Please type your name…" },
      { key: "validationType", label: "Validation", type: "select", options: [
